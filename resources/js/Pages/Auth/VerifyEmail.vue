      ...
      <CardWithLogo>
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8 item flex flex-col items-center">
          ...
          <div class="text-center">
            ...
            <span class="mt-0 pt-0 text-sm text-gray-500 dark:text-gray-400">{{
          ...
          <div class="flex w-full">
            <ButtonLinkOutline class="block w-full justify-center" :href="route('profile.show')"
              >Edit Profile</ButtonLinkOutline
            >
            <ButtonLinkOutline
              class="block w-full justify-center ms-3"
              :href="route('logout')"
              method="post"
              as="button"
              >Log Out</ButtonLinkOutline
            >
          </div>
        </div>
      </CardWithLogo>
