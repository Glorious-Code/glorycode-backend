...
import {Cog6ToothIcon, AdjustmentsVerticalIcon, HomeIcon, ClipboardDocumentListIcon} from "@heroicons/vue/24/outline";
...
const classes = {
    "container": "fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700",
    "menu-container": "overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800",
    "footer-container": "hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20",
